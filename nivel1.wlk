...
import ingrediente.*           // Clase que representa ingredientes
import contenedor.*           // Clase del contenedor de entrega
...
object nivel1 {
    ...
    method iniciarNivel() {
        ...
        game.clear()
        game.boardGround("nivel1.png")  // El fondo del nivel debe estar en la carpeta assets
        ...
        game.whenCollideDo(walter, { otro =>
            if (otro == elContenedor and walter.tieneTodosLosIngredientes()) {
                ...
                game.schedule(1500, {                   // Esperamos 1.5 segundos antes de cambiar
